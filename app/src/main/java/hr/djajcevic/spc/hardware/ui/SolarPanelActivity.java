...
public class SolarPanelActivity extends ActionBarActivity implements ActionBar.TabListener, IOIOLooperProvider {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_solar_panel, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_solar_panel, container, false);
            return rootView;
        }
    }
